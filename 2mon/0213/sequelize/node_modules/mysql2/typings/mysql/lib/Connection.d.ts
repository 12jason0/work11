...
import { Query, QueryError } from 'mysql2/typings/mysql/lib/protocol/sequences/Query.js';
import { Prepare, PrepareStatementInfo } from 'mysql2/typings/mysql/lib/protocol/sequences/Prepare.js';
import {
  OkPacket,
  FieldPacket,
  RowDataPacket,
  ...
  OkPacketParams,
  ErrorPacketParams,
} from 'mysql2/typings/mysql/lib/protocol/packets/index.js';
import { Connection as PromiseConnection } from 'mysql2/promise.js';
import { AuthPlugin } from 'mysql2/typings/mysql/lib/Auth.js';
import { QueryableBase } from 'mysql2/typings/mysql/lib/protocol/sequences/QueryableBase.js';
import { ExecutableBase } from 'mysql2/typings/mysql/lib/protocol/sequences/ExecutableBase.js';
import { TypeCast } from 'mysql2/typings/mysql/lib/parsers/typeCast.js';
